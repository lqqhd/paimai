...
import com.xiaoxing.seller.di.component.DaggerNoviceMustLearnComponent;
...
public class NoviceMustLearnActivity extends BaseActivity<NoviceMustLearnPresenter> implements NoviceMustLearnContract.View {
    ...
    public void setupActivityComponent(@NonNull AppComponent appComponent) {
        DaggerNoviceMustLearnComponent //如找不到该类,请编译一下项目
                .builder()
                .appComponent(appComponent)
                .noviceMustLearnModule(new NoviceMustLearnModule(this))
                .build()
                .inject(this);
    }
    ...
    public int initView(@Nullable Bundle savedInstanceState) {
        return R.layout.seller_client_activity_novice_must_learn; //如果你不需要框架帮你设置 setContentView(id) 需要自行设置,请返回 0
    }
