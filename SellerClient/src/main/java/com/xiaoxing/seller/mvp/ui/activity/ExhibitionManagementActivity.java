...
import com.xiaoxing.seller.di.component.DaggerExhibitionManagementComponent;
...
import com.xiaoxing.seller.mvp.presenter.ExhibitionManagementPresenter;
...
public class ExhibitionManagementActivity extends BaseActivity<ExhibitionManagementPresenter> implements ExhibitionManagementContract.View {
    ...
    public void setupActivityComponent(@NonNull AppComponent appComponent) {
        DaggerExhibitionManagementComponent //如找不到该类,请编译一下项目
                .builder()
                .appComponent(appComponent)
                .exhibitionManagementModule(new ExhibitionManagementModule(this))
                .build()
                .inject(this);
    }
    ...
    public int initView(@Nullable Bundle savedInstanceState) {
        return R.layout.activity_exhibition_management; //如果你不需要框架帮你设置 setContentView(id) 需要自行设置,请返回 0
    }
