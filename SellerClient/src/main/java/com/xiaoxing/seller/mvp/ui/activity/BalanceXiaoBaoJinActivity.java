...
import com.xiaoxing.seller.di.component.DaggerBalanceXiaoBaoJinComponent;
...
import com.xiaoxing.seller.mvp.presenter.BalanceXiaoBaoJinPresenter;
...
public class BalanceXiaoBaoJinActivity extends BaseActivity<BalanceXiaoBaoJinPresenter> implements BalanceXiaoBaoJinContract.View {
    ...
    public void setupActivityComponent(@NonNull AppComponent appComponent) {
        DaggerBalanceXiaoBaoJinComponent //如找不到该类,请编译一下项目
                .builder()
                .appComponent(appComponent)
                .balanceXiaoBaoJinModule(new BalanceXiaoBaoJinModule(this))
                .build()
                .inject(this);
    }
    ...
    public int initView(@Nullable Bundle savedInstanceState) {
        return R.layout.seller_client_activity_balance_xiao_bao_jin; //如果你不需要框架帮你设置 setContentView(id) 需要自行设置,请返回 0
    }
