...
public class GankHomeActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public GankHomeActivity_ViewBinding(GankHomeActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public GankHomeActivity_ViewBinding(GankHomeActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    GankHomeActivity target = this.target;
