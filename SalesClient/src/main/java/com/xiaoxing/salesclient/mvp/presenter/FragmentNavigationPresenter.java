...
public class FragmentNavigationPresenter extends BasePresenter<FragmentNavigationContract.Model, FragmentNavigationContract.View> {
    @Inject
    ...
    @Inject
    public FragmentNavigationPresenter(FragmentNavigationContract.Model model, FragmentNavigationContract.View rootView) {
