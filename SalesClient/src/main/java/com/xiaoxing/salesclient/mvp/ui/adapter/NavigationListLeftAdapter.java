...
public class NavigationListLeftAdapter extends BaseQuickAdapter<Category.DataBean.SecondCategoryBean, BaseViewHolder> {
    private int selectPos = 0;

    public NavigationListLeftAdapter(@Nullable List<Category.DataBean.SecondCategoryBean> data) {
        super(R.layout.sales_client_item_navigation_list_left, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, Category.DataBean.SecondCategoryBean item) {
