...
import com.xiaoxing.salesclient.di.component.DaggerWeiPaiDetailZhengChangComponent;
...
import com.xiaoxing.salesclient.mvp.presenter.WeiPaiDetailZhengChangPresenter;
...
@Route(path = RouterHub.SALES_CLIENT_WEI_PAI_DETAIL_ZHENG_CHANG_ACTIVITY)
public class WeiPaiDetailZhengChangActivity extends BaseActivity<WeiPaiDetailZhengChangPresenter> implements WeiPaiDetailZhengChangContract.View {
    ...
    public void setupActivityComponent(@NonNull AppComponent appComponent) {
        DaggerWeiPaiDetailZhengChangComponent //如找不到该类,请编译一下项目
                .builder()
                .appComponent(appComponent)
                .weiPaiDetailZhengChangModule(new WeiPaiDetailZhengChangModule(this))
                .build()
                .inject(this);
...
//        initCountdownView();
    ...
    @Override
    public void auctionDetailSuccess(AuctionDetailZhengChang auctionDetail) {
...
//            mFragments.add(FragmentQiTaPaiPin.getInstance(dataBean.getOther_goods()));
    ...
    private void setBannerData(AuctionDetailZhengChang.DataBean dataBean) {
        List<AuctionDetailZhengChang.DataBean.PicturesBean> picturesBeanList = dataBean.getPictures();
