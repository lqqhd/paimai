 ...
 */
public class FragmentWoDeGuanZhu extends BaseFragment<FragmentWoDeGuanZhuPresenter> implements FragmentWoDeGuanZhuContract.View, OnRefreshListener {
    ...
    private void getMyCollectionStoreListData() {
        mPresenter.getMyCollectionStoreList(mToken);
    }
    ...
    public void setupFragmentComponent(@NonNull AppComponent appComponent) {
        ...
        DaggerFragmentWoDeGuanZhuComponent //如找不到该类,请编译一下项目
                .builder()
                .appComponent(appComponent)
                .fragmentWoDeGuanZhuModule(new FragmentWoDeGuanZhuModule(this))
                .build()
                .inject(this);
    }
...
//                });
    ...
    public void onStart() {
        ...
        mToken = mSharedPreferencesHelper.getString(BaseConstants.TOKEN);
