...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private int mStrokeColor = getResources().getColor(R.color.red);
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mStrokeWidth = ta.getInt(R.styleable.SlidingTabLayout_tl_stroke_width, mStrokeWidth);
        mStrokeColor = ta.getColor(R.styleable.SlidingTabLayout_tl_stroke_color, mStrokeColor);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mIndicatorStyle == STYLE_TRIANGLE) {
            ...
            if (mIndicatorHeight > 0) {
                ...
                mIndicatorDrawable.setStroke(mStrokeWidth, mStrokeColor);
